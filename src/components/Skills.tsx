...
const experience = [
  ...
  {
    id: 2,
    role: 'Blind Vision Capstone Project Member',
...
<div className="mt-16 flex justify-center">
  <div className="relative">
    ...
    <div className="absolute -bottom-5 left-1/2 -translate-x-1/2">
      <button
        onClick={() => window.location.href = "#contact"} // or open a modal
        className="w-32 h-32 bg-black text-white text-sm font-light rounded-full flex flex-col items-center justify-center shadow-lg hover:scale-105 hover:bg-zinc-900 transition-all duration-300"
      >
        Work With Me
      </button>
    </div>
