      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto">
          <div className="space-y-12">
            <div>
              <h3 className="text-2xl font-light text-white mb-6">Work With Me</h3>
              <p className="text-lg text-gray-400 leading-relaxed">
                I'm just one message away. Let’s create something awesome together.
              </p>
            </div>
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <div className="text-gray-400">johnmatthew.morillo@hcdc.edu.com.ph</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <div className="text-gray-400">+63 952 108 138</div>
                </div>
              </div>
